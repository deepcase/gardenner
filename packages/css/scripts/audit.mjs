...
if (buildCatalog.version !== pkg.version || buildCatalog.platforms.length !== 5 || buildCatalog.componentPacks.length !== 28) errors.push("2.1.0 targeted build catalog is incomplete");
