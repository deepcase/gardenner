...
/// <summary>Defines a ten-axis theme scope and initializes its Gardener subtree.</summary>
public sealed class GardenerProvider : ComponentBase, IAsyncDisposable
{
    ...
    public GardenerThemeState State => new() { Theme = Theme, Mode = Mode, Neutral = Neutral, Typography = Typography, Shape = Shape, Density = Density, Elevation = Elevation, Motion = Motion, Platform = Platform, Os = Os };
