...
/// <summary>Owns the scoped JavaScript module reference used by Gardenerim services.</summary>
public sealed class GardenerimJsModule(IJSRuntime js, IOptions<GardenerimOptions> options) : IAsyncDisposable
{
