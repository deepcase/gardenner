...
export default defineConfig({
  ...
  expect: { timeout: 5000 }, reporter: "line",
  use: { baseURL: "http://127.0.0.1:4192", trace: "retain-on-failure", screenshot: "only-on-failure" },
  webServer: { command: "npm run dev -- --host 127.0.0.1 --port 4192", url: "http://127.0.0.1:4192", reuseExistingServer: true, timeout: 120000 },
  projects: [
