...
await writeFile(resolve(dist, "gardener-react.performance.json"), `${JSON.stringify({ $schema: "../metadata/performance.schema.json", schemaVersion: 1, version: "2.0.0", status: "passed", artifact: "gardener-react.min.js", metrics }, null, 2)}\n`);
