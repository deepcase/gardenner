...
const frameworkExports = [
  ...
  "configAttributes", "configure", "createGardenerimComponent", "destroy", "disconnect", "emit", "gardenerimComponents", "getConfiguration", "getInstance", "init", "observe", "refresh",
  "register", "resolveGardenerimTarget", "start", "stop", "supportedLocales", "themeAttributes", "themeAxes", "toast", "useElectronWindowControls", "useGardenerim",
  "useGardenerimBehavior", "useGardenerimEvent", "useGardenerimLocale", "useGardenerimTheme", "useGardenerimThemeContext", "useGardenerimToast", "useTauriWindowControls",
];
const typeExports = [
...
const hooks = ["useGardenerim", "useGardenerimBehavior", "useGardenerimEvent", "useGardenerimLocale", "useGardenerimTheme", "useGardenerimToast", "useTauriWindowControls", "useElectronWindowControls"];
...
await writeFile(resolve(root, "docs", "components.md"), `# Gardenerim React 组件完整目录\n\n本目录由 \`@gardenerim/css@2.1.0\` 元数据自动生成，共 ${definitions.length} 个 React 组件，无省略。所有组件支持 \`${componentProps.join("\`、\`")}\`、原生 attributes/events、children 和 ref handle。\n\n| React 导出 | CSS 组件 | 分类 | 类型 | 根选择器/类 | 行为 |\n| --- | --- | --- | --- | --- | --- |\n${table}\n`);
