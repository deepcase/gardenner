...
Gardenerim CSS 2.0.0 的官方 React 适配层，版本 `2.0.0`、状态 Stable。支持 React `>=18.3.0 <20.0.0`，完整映射 CSS 项目的 506 个组件和 66 种 DOM 行为，并提供类型安全组件、Provider、Hooks、受控值桥接、SSR 安全导入、桌面适配与按需样式。
